...
if not isExists_file:
    os.makedirs(DATASET_DIR+ '/amazon')

# Move file
if not os.path.isfile(DATASET_DIR + '/amazon/Clothing_Shoes_and_Jewelry_Result_2018.csv'):
    shutil.move(csvfile, DATASET_DIR + '/amazon')

if not os.path.isfile(DATASET_DIR + '/amazon/Clothing_Shoes_and_Jewelry.json'):
    shutil.move(jsfile, DATASET_DIR + '/amazon')
