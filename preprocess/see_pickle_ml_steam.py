...
if __name__ == "__main__":
    ...
    print("查閱平均每個用戶分配多少session | Q1:",count_sess_to_user[Q1],"Q2:",count_sess_to_user[Q2],"Q3:",count_sess_to_user[Q3])
    ...
    print("查閱平均每個session分配多少action | Q1:",count_act_to_sess[Q1],"Q2:",count_act_to_sess[Q2],"Q3:",count_act_to_sess[Q3])
    ...
    print(" --  以下數據包含" + Dataset_Name +": train + test 統計")
    ...
    pading_proportion = pading_count/items_in_sess*100
    pading_proportion = "%.2f" %pading_proportion
    print(" --  以下數據包含" + Dataset_Name +"_sample: train + test 統計")
    print(" --  資料集中的session長短分佈 [sess長短: 以及其數量]:  "+str(Session))
    print(" --  ---------------------------------------------------------------------------------------------------------------- ")
    print(" --  總計User | "+str(user_count))
    print(" --  session train | "+str(session_nums_train))
